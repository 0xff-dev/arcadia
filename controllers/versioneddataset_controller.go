...
func (r *VersionedDatasetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &arcadiav1alpha1.VersionedDataset{}
...
func (r *VersionedDatasetReconciler) preUpdate(ctx context.Context, instance *v1alpha1.VersionedDataset) (bool, error) {
	...
	if !utils.ContainString(instance.Finalizers, v1alpha1.VersionedDatasetFinalizer) {
		update = true
		instance.Finalizers = utils.AddString(instance.Finalizers, v1alpha1.VersionedDatasetFinalizer)
	}

	dataset := &arcadiav1alpha1.Dataset{}
