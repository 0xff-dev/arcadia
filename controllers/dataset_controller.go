...
func (r *DatasetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if instance.DeletionTimestamp != nil {
		if err := r.Client.DeleteAllOf(ctx, &v1alpha1.VersionedDataset{}, client.InNamespace(instance.Namespace), client.MatchingLabels{
			v1alpha1.LabelVersionedDatasetVersionOwner: instance.Name,
		}); err != nil {
			return reconcile.Result{}, err
		}
		instance.Finalizers = utils.RemoveString(instance.Finalizers, v1alpha1.LabelDatasetFinalizer)
	...
	if !utils.ContainString(instance.Finalizers, v1alpha1.LabelDatasetFinalizer) {
		instance.Finalizers = utils.AddString(instance.Finalizers, v1alpha1.LabelDatasetFinalizer)
		update = true
	}
	if update {
		err = r.Client.Update(ctx, instance)
